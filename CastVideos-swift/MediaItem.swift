...
class MediaItem: NSObject {
  ...
  ///   - imageURL: The URL of the image for this item.
  ///   - parent: The parent item of this item, if any.
  ...
  ///
  /// - Parameters:
  ///   - mediaInfo: The media information for this item.
  ///   - parent: The parent item of this item, if any.
  ...
  ///
  /// - Parameter parent: The parent item of this item.
  /// - Returns: "now playing" item
